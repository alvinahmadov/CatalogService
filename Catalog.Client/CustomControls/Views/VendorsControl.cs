...
namespace Catalog.Client
{
    class VendorsControl : BaseGridControl
    {
        ...
        private void GridControl_CreateCellElement(object sender, VirtualGridCreateCellEventArgs e)
        {
            ...
            {
                e.CellElement = new RatingCellElement(); //new QuantityCellElement();//
            }
        }
        ...
        protected override void RefreshData(int skip)
        {
            ...
            ExecuteQueryAsync<List<Vendor>>(Task.Factory.StartNew(() => query.Skip(skip).Take(this.GridControl.PageSize).ToList()), this.Callback);
        }
